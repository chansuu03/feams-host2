...
<?= $this->section('styles') ?>
  ...
  <link rel="stylesheet" href="<?= base_url()?>/public/dist/adminlte/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
<?= $this->endSection() ?>
...
<script>
  ...
  $('#election_id').change(function(){
    $.ajax({
      url: "<?php echo base_url('votes2/elec'); ?>" + "/" + $(this).val(),
